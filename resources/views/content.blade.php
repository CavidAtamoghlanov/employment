        ...
        <div>
            ...
            <div class="row">
                ...
                <div class=" col-lg-4" style="position: relative; top:35px;">
                    <div id="logo-header">
                        <img onclick="window.location='/'" src="{{ asset('front/employment-logo-2.png') }}" alt="logo"
                            style="cursor:pointer;object-fit:cover;height:110px;position:relative;top:-31px;right:-4px">
                        <h3 onclick="window.location='/'" id="employment"
                            style="cursor:pointer;font-size:42px;color: white;"><a
                                style="text-decoration: none;color:white;position:relative;"
                                href="{{ route('index') }}">Employment<span
                                    style="position: relative;top:28px;right:59px;color:#3871a6 !important;">.az</span></a>
                        </h3>
                    </div>
                </div>
                ...
                <div class="col-lg-4 drp-menu">
                    <div class="dropdown">
                        <button class=" dropdown-toggle" type="button" id="dropdownMenuButton"
                            ...
                            <a herf="#">{{ Config::get('languages')[App::getLocale()] }}</a>
                        </button>
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                             
                            @foreach (Config::get('languages') as $lang => $language)
                            @if ($lang != App::getLocale())
                                    <a class='dropdown-item' style='text-align: center;' href="{{ route('lang.switch', $lang) }}"> {{$language}}</a>
                            @endif
                        @endforeach
                            ...
                            <div class="col-lg-7 col-12" style="justify-content: center;">
                                <div class="mb-lg-0 d-flex flex-column flex-lg-row"
                                    ...
                                    <input 
                                        ...
                                        title="{{ __('static.placeh1') }}" name="search" type="text" id="job-keywords"
                                        class="form-control shadow-none" placeholder="{{ __('static.placeh1') }}"
                                        minlength="2" required>
                                    <i class="fa fa-times" id="remove_input"></i>  
                                   

                                   
                                         <span style="color:white;position: absolute;left:30px;font-weight:bold;top:70px;margin: 10px 0 0 -12px;">
                                            {{ __('static.counter1') }} <span style="color:#3871a6; font-weight:bold;">25</span> 
                                            {{ __('static.counter2') }} <span  style="color:#3871a6; font-weight:bold;">5896</span>
                                            {{ __('static.counter3') }}
                                        </span>
            ...
            <div class="col-12" id="result-container">
                        ...
                        <div id="result-count" style="margin: 40px 0;display:none;transition: all 700ms ease">
                            <div id="result"
                                ...
                                <h5 id="result-h5" style="color:white;flex: 0.4;margin-bottom:0;margin-top:70px;">
                                   {{ __('static.total_result') }} <span style="color:white;" id="count"></span>
                                </h5>
                                           ...
                                           <div class="multiselect" >
                                               <div class="selectBox">
                                                    <select class="selectoption">
                                                        <option style="display: none; height: 0px !important;" id="absered">{{ __('static.filter') }}</option>
                                                    </select>
                                                    <div class="overSelect"></div>
                                               </div>
                                               <div id="checkboxes">
                                              {{-- Js den gelirdi  check button ile shirket secimi --}}
                ...
                <div class="error-template" id="404-error" style="padding: 0;text-align: center;display: none;">
                    <h2 style="font-size: 45px;color:white">{{ __('static.error_title') }}</h2>
                    <h4 style="color:white">{{ __('static.error_subtitle') }}</h4>
                    <div class="error-details" style="color:white">
                        <p>{{ __('static.error_text') }}</p>
                    </div>
                </div>


                <div class="row jobs d-flex">
                    

                </div>
                <div id="load-button"><button onclick="loadMore()" style="background: #3871a6;" class="btn ">{{ __('static.more') }}</button></div>
                <div id="load-button1"><button onclick="loadMore1()" style="background: #3871a6;" class="btn ">{{ __('static.more') }}</button></div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4 newsletter1">
                    <h5 class="new-h5">{{ __('static.title2') }}</h5>
                    <form id="newsletter-form" class="d-flex flex-column flex-lg-row">
                        <input type="email" title="e-poçt ünvanınızı daxil edin" id="newsletter-input"
                            ...
                            placeholder="{{ __('static.placeh2') }}" required>
                    ...
                    <span style="color:white" class="sosial_icon">
                        <a style="color: white!important;text-decoration:underline"
                            href="{{ route('about') }}">{{ __('static.about') }}</a>
                          &nbsp;&nbsp;&nbsp;
                        <a style="color: white!important;text-decoration:underline"
                            href="{{ route('contact') }}">{{ __('static.contact') }}</a>
                    </span>
