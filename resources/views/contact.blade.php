        ...
        <div class="container d-flex" style="height: 100%;flex-direction:column;transition:all .4s ease;">
            <div id="logo" class="d-flex flex-column"
                ...
                <div id="logo-header"
                    ...
                    <img onclick="" src="{{ asset('front/employment-logo-2.png') }}" alt=""
                    ...
                    <h3 onclick="window.location='/'" id="employment"
                        style="font-size:42px;color: white;cursor:pointer;"><a
                            style="text-decoration: none;color:white;position:relative;" href="{{ route('index') }}">Employment<span
            ...
            <div class="row" id="main-row" style="margin:auto 0;transition: all 700ms ease">
                ...
                <div class="col-12 col-lg-7" style="color:white" id="contact-us">
                    <h3 style="margin-bottom: 15px">{{ __('static.contact_title') }}</h3>
                    <p>
                        {{ __('static.contact_p1') }}
                    </p>
                    <p>{{ __('static.contact_p2') }}</p>


                    <p>
                        {{ __('static.offerbir') }}
                        <a style="color:#3871a6;" href="https://www.butagrup.com.tr/?lang={{Session()->get('applocale')}}">{{ __('static.offeriki') }}</a>
                        {{ __('static.offeruc') }}
                        <a style="color:#3871a6;" href="mailto:info@butagrup.com.tr">{{ __('static.offerdord') }}</a>
                        {{ __('static.offerbes') }}
                    </p>
            ...
            <footer
                ...
                <div class="d-flex"
                    ...
                    <a href="{{ route('index') }}" style="color: black"><i class="fa fa-arrow-left" style="font-size: 18px;" aria-hidden="true"></i></a>
                </div>
          @endsection