    ...
    <div class="wrapper" id="my-wrapper"
        ...
        <div class="container d-flex" style="height: 100%;flex-direction:column;transition:all .4s ease;">
            <div id="logo" class="d-flex flex-column"
                ...
                <div id="logo-header" onclick="window.location='/'"
                    ...
                    <img src="./employment-logo.png" alt=""
                        style="cursor:pointer;object-fit:cover;height:110px;position:relative;top:-31px;right:-4px">
                    <h3 id="employment" style="cursor:pointer;font-size:42px;color: white;"><a
                            style="text-decoration: none;color:white;position:relative;" href="/">Employment<span
                                style="position: relative;top:28px;right:59px;color:blue!important">.az</span></a></h3>
                </div>
            </div>
            ...
            <footer
                ...
                <div onclick="window.location='/'" class="d-flex "
                    style="cursor:pointer;margin:0 auto 10px auto;width:40px;height:40px;background-color:#fff;color:black;border-radius:50%">
